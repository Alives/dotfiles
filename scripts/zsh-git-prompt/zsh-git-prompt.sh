# Copied from https://github.com/olivierverdier/zsh-git-prompt
# Be warned that parts of that repo have been modified to my liking here

# To install source this file from your .zshrc file

# Change this to reflect your installation directory
export __GIT_PROMPT_DIR=~/.dotfiles/scripts/zsh-git-prompt
# Initialize colors.
autoload -U colors
colors
...
function update_current_git_vars() {
    ...
    local gitstatus="$__GIT_PROMPT_DIR/zsh-git-prompt-gitstatus.py"
...
ZSH_THEME_GIT_PROMPT_STAGED="%{$fg_bold[blue]%}●"
